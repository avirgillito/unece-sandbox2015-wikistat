...
### Functions to get Wikidata items' categories from the Wikidata items 

## query_location_category_1: it gets the categories of items selected considering query type no.1

## query_location_category_2: it gets the categories of items selected considering query type no.2

## query_location_category_3: it gets the categories of items selected considering query type no.3

## read_category_list: it reads the list of items' categories just downloaded
...
# It returns the list of Wikidata items' categories that are geolocated into that administrative entity with Wikidata identifier
...
# It returns the list of Wikidata items' categories that are geolocated into that radius around the location with Wikidata identifier
...
# It returns the list of Wikidata items' categories that are geolocated into that box around the location with Wikidata identifier
...
# It returns a dataframe with the Wikidata identifier of the item and its category (there could be multiple categories for each item)
