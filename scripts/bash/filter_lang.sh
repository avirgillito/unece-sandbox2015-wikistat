...
usage() { echo "Usage: $0 -l <language> -i <input_dir> -o <output_dir> -t <temp_dir>" 1>&2; exit 1; }
...
echo $lang $indir $outdir $tempdir
...
do
  ...
  pig -f $pigdir/filter_lang.grunt -param input_file=$i -param output_dir=$tempdir/$yearmonth -param lang=$lang -param yearmonth=$yearmonth
done
